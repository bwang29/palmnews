...
PostageApp.configure do |config|
  config.api_key = 'BULLsUEJTlxF7o3WwGSknDRvdhup55kj'
end
...
# Use postage mail for mail service
def mail(replay,from,to,subject,body,opt={})
    request = PostageApp::Request.new(:send_message, {
      'headers'     => { 'from'     => 'borui@stanford.edu',
                         'subject'  => subject },
      'recipients'  => to,
      'content'     => {
        'text/plain'  => body,
